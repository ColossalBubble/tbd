  ...
  render() {
    return (
      <div id="selectInstrumentRoom">
        <img id="instLogo" src="../../../style/InstrumentRoomLogo.png" /><br />
        <img
          id="pianoChoose" src="http://handlinpiano2.codyhandlin.com/wp-content/uploads/2016/06/grandepiano_2.png"
          onClick={() => { this.props.sel('piano'); this.choose('pianoChoose'); }}
        />
        <img
          id="drumsChoose" src="http://www.vancouvertop40radio.com/Images/Clip%20Art/drumset.gif"
