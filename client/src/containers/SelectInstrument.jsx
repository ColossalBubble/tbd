...
choose(instrument){
  ...
  render() {
    return (
      <div><h1 style={{textAlign:"center"}}>Choose an Instrument!</h1><br />
        <img id="pianoChoose" src="http://handlinpiano2.codyhandlin.com/wp-content/uploads/2016/06/grandepiano_2.png" 
        onClick={() => {this.props.sel('piano');this.choose('pianoChoose')}}  />
        <img id="drumsChoose" src="http://www.vancouvertop40radio.com/Images/Clip%20Art/drumset.gif" 
